...
return [
    ...
    'Delete' => 'Borrar',
    'Error' => 'Error',
    'File upload failed.' => 'La carga del archivo a fallado',
    'Home' => 'Inicio',
    'Invalid data received for parameter "{param}".' => 'Datos invalidos recibidos por parametros "{param}"',
    'Login Required' => 'Ingreso requerido',
    'Missing required arguments: {params}' => 'Argumento requerido perdido {param}',
    'Missing required parameters: {params}' => 'Argumentos perdidos requeridos por parametros {param}',
    'No' => 'Noº',
    'No results found.' => 'Resultados no encontrados',
    'Only files with these MIME types are allowed: {mimeTypes}.' => 'Solo archivos con estos tipo MIME son permitidos: {mimeTypes}',
    'Only files with these extensions are allowed: {extensions}.' => 'Solo archuvis con estas extensiones son permitidos: {extensions}',
